    ...
    public partial class DocumentAddEdit : Form
    {
        ...
        public DocumentAddEdit()
        {
            ...
            if (ILG.Codex.CodexR4.Properties.Settings.Default.DocumentEncogingPolicy == true)
            {
                ...
                CEncoding.SelectedIndex = ILG.Codex.CodexR4.Properties.Settings.Default.DocumentDefaultEncoding;
            }
            else
            {
        ...
        public int EditDocumentMode(int ID)
        {
           ...
           // CLinkGrid.InitializeVarialbles(2);
            ...
            if (License.IsHistoryAccessGranted() == true)
            {
                ...
                if (License.IsDeletedInHistoryGranted() == true)
                {
 ...
 //           CCategory.DisplayLayout.Grid.Width = CAuthor.Width;
      ...
      //  private C1.C1Zip.C1ZipFile zfD;
        ...
        private bool CheckTheDocumentExistance()
        {
            ...
            if (CodexDSBehavioral.Default.CheckSaveConditionWithDocumentStatus == false) ConditionStatus = "";
            if (CodexDSBehavioral.Default.CheckSaveConditionWithDocumentCaption == false) ConditionCaption = "";
    ...
    private void DOEditDocument()
        ...
        public void CreateHistoryList()
        {
            using (new UI.WaitCursor())
            {
                ...
                this.codexDSHistoryListBox1.Configure();
                this.codexDSHistoryListBox1.DataSource = historymodel;
                this.codexDSHistoryListBox1.FillGrid();
        ...
        private void EditSelectedHistoryItem()
        {
            if (License.IsModifiedHistoryGranted() == true)
            {
                int _id = codexDSHistoryListBox1.Active_ID;
        ...
        private void DeleteSelectedHistoryItem()
        {
            ...
            private void codexDSHistoryListBox1_DocumentClick(object sender, CodexDSHistoryListBox.CodexDSHistoryListEventArgs e)
        {
            //HistoryDocument d = new HistoryDocument();
            //d.Show();
